...
namespace A4logic\Customform\Controller\Index;
...
class Index extends Action
{
    ...
    public function execute()
    {
        ...
        $fromEmail= 'contact@cannedhead.com';
        $fromName = 'Test Demo Form';
         ...
         // $templateVars = [
                    ...
                    // 'message'   => $message
                // ];
        $from = ['email' => $fromEmail, 'name' => $post['Nombre']];
        $this->inlineTranslation->suspend();


        $to = 'contacto@dobledos.com';     
        ...
        $transport = $this->_transportBuilder->setTemplateIdentifier('daily_status_template')
