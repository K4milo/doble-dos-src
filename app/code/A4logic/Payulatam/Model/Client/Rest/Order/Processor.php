...
namespace A4logic\Payulatam\Model\Client\Rest\Order;

use Magento\Framework\Exception\LocalizedException;
use Magento\Framework\Phrase;
use \A4logic\Payulatam\Model\Client\Rest\Order;

class Processor
{
    /**
     * @var \A4logic\Payulatam\Model\Order\Processor
     */
    protected $orderProcessor;

    public function __construct(
        \A4logic\Payulatam\Model\Order\Processor $orderProcessor
    ) {
