<?php
namespace Cleavercoder\Advanceshiping\Plugin\Checkout\Model\Checkout;
 ...
 return $datas;
    ...
    public function afterProcess(
       ...
       $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']['children']
        ['shippingAddress']['children']['shipping-address-fieldset']['children']['city2'] = [
            ...
            'dataScope' => 'shippingAddress.city2',
            'label' => 'city',
