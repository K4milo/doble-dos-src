...
class Interceptor extends \Mageplaza\Blog\Controller\Adminhtml\Topic\Save implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\Framework\Registry $registry, \Magento\Backend\Helper\Js $jsHelper, \Mageplaza\Blog\Model\TopicFactory $topicFactory)
    {
        $this->___init();
        parent::__construct($context, $registry, $jsHelper, $topicFactory);
    }
